package com.breezedbmindia.features.logoutsync.presentation
...
import com.breezedbmindia.app.AppDatabase
...
import com.breezedbmindia.app.utils.Toaster
import com.breezedbmindia.base.BaseResponse
import com.breezedbmindia.base.presentation.BaseActivity
import com.breezedbmindia.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezedbmindia.features.billing.api.AddBillingRepoProvider
import com.breezedbmindia.features.billing.model.AddBillingInputParamsModel
...
import com.breezedbmindia.features.dashboard.presentation.ReasonDialog
...
import com.breezedbmindia.features.document.model.AddEditDocumentInputParams
import com.breezedbmindia.features.document.model.DocumentAttachmentModel
...
import com.breezedbmindia.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezedbmindia.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezedbmindia.features.orderhistory.model.*
...
import com.breezedbmindia.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezedbmindia.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezedbmindia.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezedbmindia.features.timesheet.model.AddTimeSheetInputModel
import com.breezedbmindia.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezedbmindia.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezedbmindia.features.viewAllOrder.model.AddOrderInputProductList
import com.breezedbmindia.mappackage.SendBrod
import com.breezedbmindia.widgets.AppCustomTextView
import com.breezedbmindia.MonitorService
import com.breezedbmindia.MySingleton
import com.breezedbmindia.app.AlarmReceiver
...
import com.breezedbmindia.features.addshop.presentation.ShopExtraContactReq
...
import com.breezedbmindia.features.login.model.GetConcurrentUserResponse
import com.breezedbmindia.features.login.model.WhatsappApiData
import com.breezedbmindia.features.orderITC.SyncDeleteOppt
import com.breezedbmindia.features.orderITC.SyncDeleteOpptL
import com.breezedbmindia.features.orderITC.SyncEditOppt
import com.breezedbmindia.features.orderITC.SyncOppt
import com.breezedbmindia.features.orderITC.SyncOpptProductL
import com.breezedbmindia.features.orderITC.SyncOrd
import com.breezedbmindia.features.orderITC.SyncOrdProductL
import com.breezedbmindia.features.performance.model.Gps_status_list
import com.breezedbmindia.features.performance.model.UpdateGpsInputListParamsModel
import com.breezedbmindia.features.returnsOrder.ReturnProductList
import com.breezedbmindia.features.returnsOrder.ReturnRequest
import com.breezedbmindia.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedbmindialogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedbmindialogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedbmindialogsample/log.zip").path);
