...
class SearchLmsLearningFrag : BaseFragment() , LmsSearchAdapter.OnItemClickListener{
    ...
    private fun initView(view: View) {
        ...
        tv_next_afterSearch_lms.setOnClickListener {
            if (lmsSearchAdapter.getSelectedPosition() == RecyclerView.NO_POSITION) {
                ...
                (mContext as DashboardActivity).loadFragment(FragType.MyLearningAllVideoList, true, "")
            }
        }
